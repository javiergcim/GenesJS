...
import { mutate_swap, mutate_insert, mutate_multiple } from '../../genesjs/mutators.js';
...
function my_example() {
    ...
    const data = {
        ...
        'cost': create_distance_matrix(locations) // Costos
    };

    // Se crean valores de configuración
    const n = 1000;  // Individuos
    const gen = 30;  // Generaciones máximas
    const cp = 1.0;  // Probabilidad de cruza
    const max_mp = 0.01; // Máxima probabilidad de mutación
    ...
    const verbose = 2;  // Frecuencia de reporte
